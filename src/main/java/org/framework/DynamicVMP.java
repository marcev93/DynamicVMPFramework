...
public class DynamicVMP {
    ...
    static {
        algorithms = new Algorithm[]{
				...
				Openstack::openstackManager,							// Alg4
        };
    }
    ...
    public static void main (String[] args) throws IOException, InterruptedException, ExecutionException {
    	...
    	Path path = Paths.get("outputs/resultados/placement_score_by_time");
        //if directory exists?
		...
		File dir = new File("outputs/resultados");
                File newName = new File("outputs/"+curDate+" ");
                if ( dir.isDirectory() ) {
   ...
   /**
    ...
    private static void loadParameters(ArrayList<String> scenariosFiles, String parameterFile, String parameterFile1) throws IOException {
        ...
        /*
        try (Stream<String> stream = Files.lines(Paths.get(parameterFile,parameterFile1))) {
